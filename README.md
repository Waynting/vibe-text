...
[![Download for Windows](https://img.shields.io/badge/🪟_Windows-下載_MSI-green?style=for-the-badge&logoColor=white)](https://github.com/waynting/vibe-text/releases/latest)
...
| 🪟 **Windows** | `.msi` | Windows 10/11 x64 安裝程式（需要管理員權限） |

> 💡 **安裝提示**: 
> 
> **Windows**: 
> - 需要**管理員權限**才能安裝 `.msi` 檔案
> - 首次下載時，Windows Defender 可能會顯示安全警告，請點擊「詳細資訊」→「仍要執行」
> - 這是因為應用程式尚未購買代碼簽章憑證，但軟體本身是安全的
> 
